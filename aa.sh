...
install_app() {
    ...
    read -p "请输入允许访问的域名 (HOMEPAGE_ALLOWED_HOSTS): " ALLOWED_HOST
    read -p "请输入 PUID [默认:1000]: " input_puid
    read -p "请输入 PGID [默认:1000]: " input_pgid

    PUID=${input_puid:-1000}
    PGID=${input_pgid:-1000}
