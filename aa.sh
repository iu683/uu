...
fail2ban_menu() {
    while true; do
        ...
        echo -e "${GREEN} 监听端口 : ${YELLOW}${PORT_SHOW}${RESET}"
        echo -e "${GREEN} 封禁数量 : ${YELLOW}${SITE_COUNT} 个 IP${RESET}"
        echo -e "${GREEN}===============================${RESET}"
        echo -e "${GREEN}  1. 安装并开启 SSH 防护${RESET}"
        echo -e "${GREEN}  2. 关闭 SSH 防护功能${RESET}"
        ...
        echo -e "${GREEN}  7. 卸载 Fail2Ban 程序${RESET}"
