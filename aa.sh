...
# ----- 菜单选项列表 (一行显示两个，完全对齐) -----
echo -e "${GREEN} 1.启动服务${RESET}        | ${GREEN} 2.停止服务${RESET}"
echo -e "${GREEN} 3.重启服务${RESET}        | ${GREEN} 4.修改用户名${RESET}"
echo -e "${GREEN} 5.修改密码${RESET}        | ${GREEN} 6.修改面板端口${RESET}"
echo -e "${GREEN}======================================${RESET}"
echo -e "${GREEN} 7.取消安全入口${RESET}    | ${GREEN} 8.取消HTTPS登录${RESET}"
echo -e "${GREEN} 9.取消IP限制${RESET}      | ${GREEN}10.取消两步验证${RESET}"
echo -e "${GREEN}11.取消域名绑定${RESET}    | ${GREEN}12.监听 IPv4${RESET}"
echo -e "${GREEN}13.监听 IPv6${RESET}       | ${GREEN}14.用户信息${RESET}"
echo -e "${GREEN}15.更新拓展App${RESET}"
echo -e "${GREEN}======================================${RESET}"
echo -e "${CYAN}66.安装 1Panel${RESET}     | ${RED}77.卸载 1Panel${RESET}"
echo -e "${GREEN}======================================${RESET}"
