...
setup_host_nginx() {
    ...
    echo -ne "${YELLOW}请输入您的反代域名 [默认: mcyss.otg.dpdns.org]: ${RESET}"
    read -r custom_domain
    [[ -z "$custom_domain" ]] && custom_domain="mcyss.otg.dpdns.org"
    echo "$custom_domain" > "$NGINX_CONF_DIR/host_domain.txt"
