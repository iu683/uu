...
$HOSTNAME-Snell+ShadowTLS = snell, $IP, $stls_port, psk=$psk, version=6, tfo=$tfo, shadow-tls-password=$stls_pwd, shadow-tls-sni=$stls_sni, shadow-tls-version=3, ecn=true
EOF
