...
# ===============================
# 防火墙管理脚本（Debian/Ubuntu 双栈 IPv4/IPv6 - Docker 完美兼容版）
# ===============================
...
init_rules() {
    ...
    for proto in iptables ip6tables; do
        ...
        # 基础放行规则（这里全部用 -A 追加，后续用户添加白名单用 -I 1 就能永远排在最前面）
...
clear_firewall() {
    ...
    # 如果存在 DOCKER-USER 链，顺便把针对 Docker 的 IP 封禁也安全清空掉
