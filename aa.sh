...
# =========================================================
# Snell v5 + Shadow-TLS v3 一体化独立管理脚本（最终修正版）
# =========================================================
...
# 启动项修复：移除了末尾不受新版支持的孤立 'v3' 参数
ExecStart=${STLS_File} server --password \$STLS_PASSWORD --listen \$STLS_LISTEN --server \$STLS_SERVER --tls \$STLS_TLS
