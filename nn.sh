...
install() {
    ...
    read -p "请输入 Uptime Kuma 基础 URL (必填): " UPTIME_KUMA_BASE_URL
...
show_info() {
    ...
    echo -e "访问地址: ${YELLOW}http://127.0.0.1:${KUMA_PORT}${RESET}"
