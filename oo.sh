...
menu() {
    ...
    echo -e "${GREEN} 9.${RESET} ${YELLOW}节点管理${RESET}"
    ...
    case "$choice" in
        ...
        7) logs_ppanel ;;
        8) show_info ;;
        9) bash <(wget -qO- https://raw.githubusercontent.com/perfect-panel/ppanel-node/master/scripts/install.sh) ;;
        0) exit 0 ;;
