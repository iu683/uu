...
# ==============================================================================
#  next-socks5 一键管理面板 (Alpine Linux OpenRC 专属原生完美版)
# ==============================================================================
...
# ── 🛠️ 核心重构：Alpine OpenRC 原生守护服务脚本生成器 ─────────────────────────
write_openrc() {
...
# 核心修复点：启用原生后台引擎并指派 PID 链锁，彻底根治 --stdout 冲突报错
