...
update_snell_v5() {
    ...
    _ok "Snell 已成功更新至版本 v$ver，且当前配置已完好保留并重启完毕！"
    log "Alpine Snell 成功更新至 v$ver"
}
