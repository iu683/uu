...
# ==============================================================================
#   模块一：Google 透明代理 (处理 is already running 冲突逻辑)
# ==============================================================================
...
EOF
    ...
    # 【优雅避险】：启动前强制清理已经占用的残留 redsocks，彻底解决 already running 问题
    rc-service "$PROXY_SERVICE_NAME" stop >/dev/null 2>&1
