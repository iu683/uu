...
MYSQL_DB_NAME="dnsmgr"             # 数据库名
MYSQL_USER="dnsmgruser"            # 专用用户
MYSQL_PASSWORD="dnsmgrpass"        # 专用用户密码
...
function show_info() {
    ...
    echo -e "${YELLOW}MySQL 用户名:${RESET} $MYSQL_USER"
    echo -e "${YELLOW}MySQL 密码:${RESET} $MYSQL_PASSWORD"
