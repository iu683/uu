...
# ==============================================================================
#  cf-warp-rust 一键管理面板（高级透明代理·完美修复版）
# ==============================================================================
...
start_transparent_proxy() {
    ...
    # 【修复关键点 1】关闭并禁用自带的 redsocks 默认服务，防止抢占 12345 端口
...
EOF
    ...
    # 【修复关键点 2】将 iptables 规则写进独立的高性能控制脚本，彻底规避 Systemd 解析崩溃
...
EOF
    ...
    # 【修复关键点 3】重新设计极简、高稳健性的守护式 Systemd 服务
