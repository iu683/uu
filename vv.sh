#!/bin/sh
# ========================================
# qBittorrent-Nox 一键管理脚本 (Alpine 专属完美版)
# ========================================
